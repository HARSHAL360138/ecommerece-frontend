    ...
    <footer className="bg-[#002349] text-gray-200 pt-10 pb-6 px-6 md:px-16">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8 text-sm">
        ...
        <div>
          <h3 className="text-[#957C3D] font-semibold mb-3">Customer Services</h3>
          <ul className="space-y-2">
            <li><Link to="/customer-service" className="hover:text-[#957C3D]">Help Center</Link></li>
            <li><Link to="/customer-service" className="hover:text-[#957C3D]">Policies & Rules</Link></li>
            <li><Link to="/customer-service" className="hover:text-[#957C3D]">Online Returns Policy</Link></li>
            <li><Link to="/customer-service" className="hover:text-[#957C3D]">Report Abuse</Link></li>
          </ul>
        </div>
        ...
        <div>
          <h3 className="text-[#957C3D] font-semibold mb-3">My Account</h3>
          <ul className="space-y-2">
            <li><Link to="/checkout" className="hover:text-[#957C3D]">Checkout</Link></li>
            <li><Link to="/redeem-voucher" className="hover:text-[#957C3D]">Redeem Voucher</Link></li>
            <li><Link to="/product-support" className="hover:text-[#957C3D]">Product Support</Link></li>
            <li><Link to="/wishlist" className="hover:text-[#957C3D]">Wishlist</Link></li>
          </ul>
        </div>
        ...
        <div>
          <h3 className="text-[#957C3D] font-semibold mb-3">Quick Links</h3>
          <ul className="space-y-2">
            <li><Link to="/my-account" className="hover:text-[#957C3D]">My Account</Link></li>
            <li><Link to="/order-tracking" className="hover:text-[#957C3D]">Order Tracking</Link></li>
            <li><Link to="/faqs" className="hover:text-[#957C3D]">FAQs</Link></li>
            <li><Link to="/store-location" className="hover:text-[#957C3D]">Store Location</Link></li>
          </ul>
        </div>
      </div>
