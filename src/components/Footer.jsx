  ...
  <footer className="bg-[#002349] text-gray-200 pt-10 pb-6 px-6 md:px-16">
    <div className="grid md:grid-cols-2 gap-8 border-b border-[#957C3D]/50 pb-8">
      <div>
        ...
        <p className="text-sm mb-4">Connect with us on social media for latest updates and offers.</p>
      ...
      <div>
        ...
        <p className="text-sm mb-4">Join 60,000+ subscribers and get a discount coupon every week.</p>
        <div className="flex">
          <input type="email" placeholder="Your email address" className="w-full p-2 rounded-l-md text-gray-800 focus:outline-none" />
          <button className="bg-[#957C3D] hover:bg-[#FFC966] text-[#002349] px-4 py-2 rounded-r-md font-semibold">SUBSCRIBE</button>
        </div>
        <p className="text-xs mt-2 text-gray-300">We don’t send spam emails and we won’t share your email with anyone.</p>
      </div>
    </div>
    ...
    <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8 text-sm">
      <div>
        ...
        <p className="mb-4">We provide the best customer experience in fashion and apparel without compromise.</p>
        <div className="flex items-center space-x-2 text-[#957C3D]"><FaPhoneAlt /><span>+977-1-4000000</span></div>
